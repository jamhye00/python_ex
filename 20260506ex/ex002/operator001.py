...
# print(10 + 20)
# print(3.14 + 5)
# num1 = 10; num2 = 100 # 같은 행에 두 값을 적을 때 ;로 구분
# print(num1 + num2)

# # Quiz) DW 전자 회사에서 1분기 매출의 총합을 구하고자 합니다.
# # 프로그램을 작성해봅시다.
# sales1 = int(input('1월 매출: '))
# sales2 = int(input('2월 매출: '))
# sales3 = int(input('3월 매출: '))
# tatal = sales1 + sales2 + sales3
# # print(f'1분기 매출: {tatal}')
# print(f'1분기 매출: {tatal:,}원') # 원 단위 붙일 때
...
# # 문자열 곱셈(자주 씀)
# str = "hello"       # hello hello hello 출력하고 싶을때
# print(str * 3)      # python에서는 문자열 곱셈이 가능
...
# Quiz) 'Good morning' 문자열을 사용자가 입력한 숫자만큼
# 출력하는 프로그램 만들어보기
intro = 'Good morning '
