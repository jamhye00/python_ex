...
#     if n % trainA == 0 and n % trainB and n % trainC == 0:
...
관리자가 암호를 입력하고 로그인을 시도할 때 암호가 틀렸다면
'암호를 다시 확인해세요!'를 출력하고 다시 암호를 물어봅니다.
...
#         count += 1
#         if inputNum > ranNum:
#             print(f'{inputNum}이 난수보다 큽니다.')
#         if inputNum < ranNum:
#             print(f'{inputNum}이 난수보다 작습니다.')
...
#         width = 2
#     else:
#         width += 2          # width가 1이 아닌 경우

#     if height == 1:          # width가 1인 경우
#         height = 3
#     else:
#         height += 3          # width가 1이 아닌 경우

# print(f'가장 작은 넓이는 {minArea}')
