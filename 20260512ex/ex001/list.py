...
# fruits = ['사과', '포도', '수박', '참외', '배', '자두', '복숭아', '바나나']
# print(fruits[1])            # 대괄호 안에 인덱스 번호를 넣어줌
# print(f'fruits[0]: {fruits[0]}')

# 만약 리스트에서 존재하지 않는 인덱스를 참조하면 어떻게 될까요?
# print(f'fruits[0]: {fruits[8]}')        # IndexError
# 당연히 에러가 발생합니다.
...
# str = "helll lll llllll llllo"
# print(len(str))

# quiz) 사용자가 입력한 글자 수 확인하기.
'''
...
# 리스트 연결하기
# 리스트에 또 다른 리스트를 연결할 때에는 extend() 함수를 사용합니다.
# list1 = [1, 2, 3]
# print(f'list1: {list1}')
